        ...
        >
            <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
                ...
                <nav className="hidden md:flex items-center gap-8 font-medium">
                    <Link href="/" className="text-white hover:text-primary transition-colors drop-shadow-md">홈</Link>
                    <Link href="/search" className="text-white/80 hover:text-white transition-colors drop-shadow-md">탐색</Link>
                    <Link href="/search?status=RELEASING" className="text-white/80 hover:text-white transition-colors drop-shadow-md">인기</Link>
                    <Link href="/search?status=NOT_YET_RELEASED" className="text-white/80 hover:text-white transition-colors drop-shadow-md">예정</Link>
                </nav>
